...
export default {
  ...
  draw(g, rows, [x0, y0, x1, y1], ctx) {
    ...
    const gx0 = x0 + core.axisRoom(names[1], ctx) + labW, gy0 = y0 + S * 0.06, gy1 = y1 - S * 0.12;
    ...
    core.axisNames(axis, names, ctx, { x0, px0: gx0, px1: x1, py0: gy0, py1: gy1, below: gy1 + S * 0.055 });
